...
public class WoodBlocks {
    ...
    public void clientRegistries() {
        ...
        // signs
        SpriteIdentifierRegistry.INSTANCE.addIdentifier(new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, new Identifier(TheRoofedCanyon.MOD_ID, "entity/signs/" + id)));
    }
